    ...
    <div className="space-y-5">
      ...
      <article className="print-sheet card p-8">
        ...
        <footer className="mt-6 border-t border-line pt-3 text-[10.5px] text-faint">
          Generated by MRV-BlueCarbon prototype on {dateShort(new Date().toISOString())} ·
          document {project.code}-MR-{campaign.vintage}-v1 · all figures recomputed
          from the stored dataset at generation time.
        </footer>
      </article>
    </div>
  );
